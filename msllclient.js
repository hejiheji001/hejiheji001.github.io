...
var showIn = function(){
  $("#in").append("<input type=text class=form-control id=rand placeholder=短信验证码><iframe id=frame src='' style='position: fixed; border: 1px solid black; bottom: 20px; left: 0px;background-color: yellow;width: 100%;height: 50%;'>");
