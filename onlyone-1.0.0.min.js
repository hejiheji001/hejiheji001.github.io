...
Cs.lib.Cipher || (function(h) {
        ...
        _createHelper: (function() {
            ...
            return function(d) {
                return {
                    encrypt: function() {
                        var a = "";
                        var b = Cs.enc.Utf8.parse("0123456789abcdef");
                        var c = {
                            mode: Cs.mode.ECB,
                            padding: Cs.pad.Pk
                        };
    ...
    var G = F.OpenSSL = {
        execute: function(a, b, c, d) {
            ...
            var f = l.create(e.w.slice(b), c * 4);
            e.sigBytes = b * 4;
            return A.create({
                key: e,
                iv: f,
...
(function() {
    ...
    C.EC = u._createHelper(J)
}());
Cs.mode.ECB = (function() {
    var c = Cs.lib.BlockCipherMode.extend();
