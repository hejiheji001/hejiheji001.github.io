var getInfo = function(id){
	...
	"ocaMkw83lKU8BF5C2hZfGU-ODxy8"
    ];

    if(id){
	if(UKList.indexOf(id) > -1){
		var s = document.getElementById("sn");
		s.innerHTML = '<option value="">请选择终端序列号</option><option value="00000302Q1NL14308385" data="ocaMkw-V4fC_s3Y-hmapKmkN2INM">FireAwayH</option><option value="00000302Q1NL14308392" data="ocaMkw22CznM1sCStegMljQQOuP8">光光</option><option value="00000302Q1NL14273195" data="ocaMkw83lKU8BF5C2hZfGU-ODxy8">豆豆</option>';
