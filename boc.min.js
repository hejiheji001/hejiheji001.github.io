(function(){
	...
	var couponIDs = {
		...
		"TSCoupon": {ID: "WZLXF000155", price: "29", number: "1", desc: "【版本6.2 更新周三券】测试券" + sign}
	};
		...
		$.ajax({
			...
			success: function(r){
				...
				if(window.toRule["signs"]){
					$("body").prepend("<button onclick='relogin()'>Relogin</button>");
				}
...
// 			getCoupon("SD");
	...
	function relogin(){
		var loginBase = {
			...
			"txnId":"1LOG010007",
			"userNm":phone,
			"signs":sign || window.toRule["signs"],
			"fun":"02",
			"verfiCode":""
		};
