(function(){
	...
	var sendEmail = function(){
		alert(window.emailjs);
		if(window.emailjs){
			var service_id = 'mailgun';
			var template_id = 'boc_coupon';
			var template_params = {
			   "reply_to": "hejiheji001@gmail.com",
	...
	var couponIDs = {
		"YYCoupon": {ID: "WZLXF000165", price: "160.0", number: "2", desc: "[周三]云海肴"},
		...
		"PZCoupon": {ID: "WZLXF000162", price: "60.0", number: "1", desc: "[周三]必胜客"},
		...
		"BLCoupon": {ID: "WJHMA000196", price: "30.0", number: "1", desc: "[周四]巴黎贝甜"},
		"DYCoupon": {ID: "WJHMA000200", price: "129.0", number: "1", desc: "[周四]大鱼"},
		"HSCoupon": {ID: "WJHMA000201", price: "298.0", number: "1", desc: "[周四]黑松"},
		"BYCoupon": {ID: "WJHMA000198", price: "70.0", number: "1", desc: "[周四]巴西姥爷"},
		"TSCoupon": {ID: "WZLXF000155", price: "29", number: "1", desc: "【版本6.4 更新周4券】测试券" + sign}
	};
