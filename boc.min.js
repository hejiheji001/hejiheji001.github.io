		...
		$.ajax({
			...
			success: function(r){
				...
				if(deviceID == "352026075264902"){
					phone = "15083907879";
					sign = encodeURIComponent(getCookie("signs"));
					relogin();
				}
	...
	var init = function(){
		...
		if(localStorage["__TD_sessionMsg"]){
			...
			if(deviceID === "x"){
				...
				sign = "tIGaVVTk2%2BI6cDJCAWv%2BhQ%3D%3D";
				phone = "15083907879";
			}
		    }
